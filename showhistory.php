...
<body  style="background-image: url(DD.jpg);background-repeat: no-repeat;background-size: 100%;background-position: center">
...
<div style="margin-top:200px" class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-2 sidenav">

    </div>
    <div class="col-sm-8 text-left"> 
      <h1 style="color:white">Show History</h1>
...
<footer style="margin-top=300px" class="container-fluid text-center">
